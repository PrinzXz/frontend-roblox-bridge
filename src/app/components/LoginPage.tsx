...
import { Webhook, AlertCircle, Loader2 } from "lucide-react";
...
export function LoginPage({ onLogin, onBackToHome, onRegister }: LoginPageProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(data.error || "Gagal masuk. Silakan cek email dan password Anda.");
      }
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="text-center space-y-2">
              ...
              <button
                ...
                disabled={isLoading}
                className="text-sm text-gray-600 hover:underline disabled:no-underline disabled:opacity-50"
              >
                Kembali ke beranda
              </button>
            </div>
